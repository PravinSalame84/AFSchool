...
const socialLinks = [
  ...
  { label: 'Instagram', href: siteConfig.social.instagram, icon: Instagram, color: socialColors.instagram },
  { label: 'X', href: siteConfig.social.x, icon: Twitter, color: socialColors.x },
  { label: 'YouTube', href: siteConfig.social.youtube, icon: Youtube, color: socialColors.youtube },
  { label: 'LinkedIn', href: siteConfig.social.linkedIn, icon: Linkedin, color: socialColors.linkedin },
]
  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow: 'hidden',
        background: isDark
          ? `linear-gradient(135deg, ${brandColors.navyNight} 0%, ${brandColors.slate} 100%, ${brandColors.navy} 45%)`
          : `linear-gradient(180deg, ${brandColors.navy} 0%, ${brandColors.slate} 100%, ${brandColors.navyBlue} 55%)`,
      }}
    >
      <Box
        sx={{
          ...
          pointerEvents: 'none',
          background:
            `radial-gradient(circle at top right, ${alpha(brandColors.amber, 0.18)}, transparent 24%), radial-gradient(circle at left, ${alpha(brandColors.slateInfo, 0.2)}, transparent 28%)`,
        }}
      />
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', px: { xs: 2, sm: 3, md: 4 } }}>
        <Paper
          ...
          sx={{
            ...
            borderRadius: 4,
            p: { xs: 2.5, md: 3.5 },
            bgcolor: alpha(brandColors.white, isDark ? 0.08 : 0.1),
            border: `1px solid ${alpha(brandColors.white, isDark ? 0.1 : 0.14)}`,
                ...
                {schoolContent.hero.badges.map((badge) => (
                  <Paper
                    ...
                    sx={{
                      ...
                      py: 0.8,
                      borderRadius: 4,
                      bgcolor: alpha(brandColors.sky, 0.12),
                      color: brandColors.white,
              ...
              <Stack direction="row" flexWrap="wrap" gap={1} justifyContent={{ xs: 'flex-start', lg: 'flex-end' }} sx={{ mt: 2 }}>
                {connectLinks.map(({ label, href, icon: Icon }) => (
                  <Button
                    ...
                    sx={{
                      color: brandColors.white,
                      borderColor: alpha(brandColors.white, 0.18),
                      width: { xs: '100%', sm: 'auto' },
                      justifyContent: 'center',
                      '&:hover': {
                        borderColor: alpha(brandColors.white, 0.34),
                        bgcolor: alpha(brandColors.sky, 0.12),
                      },
                    }}
                  >
        ...
        <Grid container spacing={3}>
              ...
              {schoolContent.quickLinks.map((link) => (
                <Button
                  ...
                  sx={{
                    ...
                    color: brandColors.white,
                    px: 0,
                    '&:hover': { bgcolor: 'transparent', color: brandColors.gold },
                  }}
                >
                  {link.label}
                </Button>
          ...
          <Grid item xs={12} md={2}>
            ...
            <Stack spacing={1} sx={{ mt: 2 }}>
              <Button component={Link} to="/privacy-policy" startIcon={<ShieldCheck size={16} />} sx={{ justifyContent: 'flex-start', color: brandColors.white, px: 0 }}>
                Privacy Policy
              </Button>
              <Button component={Link} to="/terms" startIcon={<FileText size={16} />} sx={{ justifyContent: 'flex-start', color: brandColors.white, px: 0 }}>
                Terms
              </Button>
            </Stack>
          </Grid>
        ...
        <Divider sx={{ my: 4, borderColor: alpha(brandColors.white, 0.12) }} />

        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
          <Typography variant="body2" sx={{ color: alpha(brandColors.white, 0.68) }}>
