...
export default function Admissions() {
  ...
  return (
    <>
      <Seo
        title="Admissions"
        description="Start an admission enquiry for Air Force School, VayuSena Nagar, Nagpur and review the basic process and required documents."
        path="/admissions"
        ...
        <Container>
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_0.8fr]">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-base leading-relaxed text-primary-700 dark:text-slate-300">{step}</p>
                      </div>
                    </div>
                  </motion.div>
                )
            ...
            >
              ...
              <h2 className="mt-3 text-4xl font-bold uppercase leading-[0.92] text-primary-900 dark:text-white">Keep these ready.</h2>
              <ul className="mt-6 space-y-3 text-sm leading-relaxed text-primary-600 dark:text-slate-300">
                {schoolContent.admissions.documents.map((document) => (
                  <li key={document} className="rounded-[1.4rem] border border-primary-900/8 bg-white/80 px-4 py-3 shadow-soft dark:border-white/10 dark:bg-primary-950/70">
                    {document}
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Button variant="outline" to={schoolContent.resources[0].to}>
                  View Documents
                </Button>
              </div>
            </motion.div>
