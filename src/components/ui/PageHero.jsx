...
export default function PageHero({ eyebrow, title, subtitle, crumb, image }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-secondary via-primary-900 to-primary-700 py-16 sm:py-20">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(240,147,75,0.22),transparent_28%),radial-gradient(circle_at_left,rgba(93,138,168,0.24),transparent_24%)]" />
